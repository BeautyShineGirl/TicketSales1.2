...
public class UserDaoImp implements UserDao{
	...
	//根据关键词查询景区	杨立	2018-01-29
	public List<ViewMessage> getKeyWordView(String keyWord) {
		return template.selectList("user.getKeyWordView", keyWord);
	}
	//获得景区的最低价	2018-01-29	yangli
	public Double getMinPrice(int id) {
		return template.selectOne("user.getMinPrice", id);
	}
	//查骏图的产品编号，juntuPId	2018-02-08
	public Product getJuntuPId(Integer productId) {
		return template.selectOne("user.getJuntuPId",productId);
	}
	//根据订单orderId保存订单流水号	yangli	2018-02-08
	public int updateRefundId(String orderId,String refundId) {
		Map<String,Object> map=new HashMap<String, Object>();
		map.put("refundId", refundId);
		map.put("orderId", orderId);
		return template.update("user.updateRefundId",map);
	}
	...
	public int updateRefund(String orderId, Integer status_no,
		...
		Map<String,Object> map=new HashMap<String, Object>();
		map.put("orderId", orderId);
		map.put("supplierOrderState", status_no);
